...
hashtag_count_rdd2 = hashtag_count_rdd.coalesce(5)
...
sorted_hashtag_count_rdd = hashtag_count_rdd2.sortBy(lambda x: x[1], ascending=False)
...
top_hashtags_rdd.saveAsTextFile("/storage/home/hxw5245/Lab8Partition/top_hashtags_cluster2.txt")
...
for i in range(0, top_k ):
    ...
    filename = "/storage/home/hxw5245/Lab8Partition/0417_UserID_cluster2" + top_hashtag_list[i]
